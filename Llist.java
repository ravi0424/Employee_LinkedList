...
//   Validates an Emp_details object and prints errors to console
    ...
    public String writeEmployeedetails(Emp_details ob){
        return ob.getEmp_id()+","+ob.getName()+","+ob.getRole()+","+ob.getExperience()+","+ob.getAge();
    }
    public String FinalWrite(){
        if(head==null){
            return null;
        }
        String s="";
        Node temp=head;
        while(temp!=null){
            s+=String.valueOf(writeEmployeedetails(temp.object))+"\n";
            temp=temp.next;
        }
        return s.trim();
    }
    ...
    public Llist.Emp_details getTail() {
        return tail.object;
    }
    ...
    private  class Node{
        ...
        public Node(Emp_details object, Llist.Node next) {
            this.object = object;
            this.next = next;
        }
        
    }
    public static class Emp_details{
        private int Emp_id;
        private String Name;
        private String Role;
